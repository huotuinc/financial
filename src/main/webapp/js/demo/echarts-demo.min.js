...
$(function () {
    ...
    var r = echarts.init(document.getElementById("echarts-scatter-chart")), o = {
        title: {
            text: "男性女性身高体重分布",
    ...
    var i = echarts.init(document.getElementById("echarts-k-chart")), m = {
        title: {text: "2013年上半年上证指数"},
        tooltip: {
            trigger: "axis", formatter: function (e) {
                var a = e[0].seriesName + " " + e[0].name;
                return a += "<br/>  开盘 : " + e[0].value[0] + "  最高 : " + e[0].value[3], a += "<br/>  收盘 : " + e[0].value[1] + "  最低 : " + e[0].value[2]
            }
        },
        legend: {data: ["上证指数"]},
        grid: {x: 40, x2: 2},
    ...
    var d = echarts.init(document.getElementById("echarts-radar-chart")), h = {
        title: {
            text: "预算 vs 开销",
            subtext: "纯属虚构"
        },
        ...
        polar: [{
            indicator: [{text: "销售", max: 6e3}, {text: "管理", max: 16e3}, {text: "信息技术", max: 3e4}, {
                text: "客服",
                max: 38e3
            }, {text: "研发", max: 52e3}, {text: "市场", max: 25e3}]
        }],
        calculable: !0,
        series: [{
            name: "预算 vs 开销",
            ...
            data: [{
                ...
                name: "预算分配"
            }, {value: [5e3, 14e3, 28e3, 31e3, 42e3, 21e3], name: "实际开销"}]
        }]
    };
    ...
    var g = echarts.init(document.getElementById("echarts-chord-chart")), v = {
        title: {
            text: "测试数据",
            subtext: "From d3.js",
            x: "right",
        ...
        toolbox: {
            show: !0,
            feature: {restore: {show: !0}, magicType: {show: !0, type: ["force", "chord"]}, saveAsImage: {show: !0}}
        },
    ...
    var y = echarts.init(document.getElementById("echarts-force-chart")), p = {
        title: {
            text: "人物关系：乔布斯",
            subtext: "数据来自人立方",
            x: "right",
        ...
        series: [{
            ...
            name: "人物关系",
            ribbonType: !1,
            categories: [{name: "人物"}, {name: "家人"}, {name: "朋友"}],
            itemStyle: {
                normal: {
                    label: {show: !0, textStyle: {color: "#333"}},
            ...
            scaling: 1.1,
            roam: "move",
            nodes: [{category: 0, name: "乔布斯", value: 10}, {category: 1, name: "丽萨-乔布斯", value: 2}, {
                category: 1,
                name: "保罗-乔布斯",
                value: 3
            }, {category: 1, name: "克拉拉-乔布斯", value: 3}, {category: 1, name: "劳伦-鲍威尔", value: 7}, {
                category: 2,
                name: "史蒂夫-沃兹尼艾克",
                value: 5
            }, {category: 2, name: "奥巴马", value: 8}, {category: 2, name: "比尔-盖茨", value: 9}, {
                category: 2,
                name: "乔纳森-艾夫",
                value: 4
            }, {category: 2, name: "蒂姆-库克", value: 4}, {category: 2, name: "龙-韦恩", value: 1}],
            links: [{source: "丽萨-乔布斯", target: "乔布斯", weight: 1, name: "女儿"}, {
                source: "保罗-乔布斯",
                target: "乔布斯",
                weight: 2,
                name: "父亲"
                ...
                target: "奥巴马",
                weight: 6
            }, {source: "比尔-盖茨", target: "克拉拉-乔布斯", weight: 1}, {source: "蒂姆-库克", target: "奥巴马", weight: 1}]
        }]
    };
    ...
    var w = echarts.init(document.getElementById("echarts-funnel-chart")), b = {
        ...
        series: [{
            ...
            type: "funnel",
            width: "40%",
            data: [{value: 60, name: "访问"}, {value: 40, name: "咨询"}, {value: 20, name: "订单"}, {
                value: 80,
                name: "点击"
            }, {value: 100, name: "展现"}]
        }, {
