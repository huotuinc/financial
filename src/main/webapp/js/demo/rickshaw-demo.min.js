...
$(function () {
    var e = new Rickshaw.Graph({
        ...
        series: [{color: "#1ab394", data: [{x: 0, y: 40}, {x: 1, y: 49}, {x: 2, y: 38}, {x: 3, y: 30}, {x: 4, y: 32}]}]
    });
    e.render();
    ...
    r.renderer.unstack = !0, r.render();
    var a = new Rickshaw.Graph({
        element: document.querySelector("#rickshaw_line"),
        renderer: "line",
        series: [{data: [{x: 0, y: 40}, {x: 1, y: 49}, {x: 2, y: 38}, {x: 3, y: 30}, {x: 4, y: 32}], color: "#1ab394"}]
    });
    a.render();
    var y = new Rickshaw.Graph({
        ...
        series: [{
            ...
            color: "#1ab394"
        }, {data: [{x: 0, y: 20}, {x: 1, y: 24}, {x: 2, y: 19}, {x: 3, y: 15}, {x: 4, y: 16}], color: "#d7d7d7"}]
    });
    y.render();
    ...
    var c = new Rickshaw.Graph({
        ...
        stroke: !0,
        padding: {top: .05, left: .05, right: .05},
        series: [{
            data: [{x: 0, y: 15}, {x: 1, y: 18}, {x: 2, y: 10}, {x: 3, y: 12}, {x: 4, y: 15}, {
                x: 5,
                y: 24
            }, {x: 6, y: 28}, {x: 7, y: 31}, {x: 8, y: 22}, {x: 9, y: 18}, {x: 10, y: 16}], color: "#1ab394"
        }]
    });
    c.render()
});