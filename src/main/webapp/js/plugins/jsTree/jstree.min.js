...
(function (factory) {
    ...
    $.jstree.defaults.contextmenu = {
        select_node: true, show_at_node: true, items: function (o, cb) {
            return {
                "create": {
                ...
                "ccp": {
                    ...
                    "submenu": {
                        ...
                        "paste": {
                            "separator_before": false, "icon": false, "_disabled": function (data) {
    ...
    (function ($) {
        ...
        $.vakata.context = {
            settings: {hide_onmouseleave: 0, icons: true}, _trigger: function (event_name) {
                $(document).triggerHandler("context_" + event_name + ".vakata", {
                    "reference": vakata_context.reference,
                    "element": vakata_context.element,
                    "position": {"x": vakata_context.position_x, "y": vakata_context.position_y}
                })
            }, _execute: function (i) {
    ...
    $.jstree.defaults.unique = {
        case_sensitive: false, duplicate: function (name, counter) {
            return name + " (" + counter + ")"
        }
    };
