        ...
        init: function (fa) {
            return this.each(function () {
                ...
                if (!e.data("isActive")) {
                    ...
                    e.before(g);
                    var p = e.prev(), J = c(ea.body), T = c($), q, C, D, A, B, w, x, m, t, r, H, M, v = !1, y = !1, E = !0, f = {}, U = 0, O = 0, P = 0, l = 0, F = 0, G = 0, V = 0, Q = 0, R = 0, Y = 0, u = 0;
                    parseInt(a.step,
                    ...
                    var ba = function () {
                        ...
                        var a = m.width(), d = c.data(m[0], "x") || parseInt(m[0].style.left, 10) || m.position().left, h = (c.data(t[0],
